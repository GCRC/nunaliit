...
public class PgSyncActions {
	...
	private String loc_type = "col";
	private String[] loc_langs = { "en", "fr" };
	...
	public void syncAllDocs() throws Exception {
		...
		Map<String, Map<String, Map<String, String>>> schemas = createPgTables(results);
		...
		for (String schemaName : schemas.keySet()) {
			...
			syncDocsForSchema(docResults, schemaName, schemas);
		}
		insertLinks();
	...
	private Map<String, Map<String, Map<String, String>>> createPgTables(CouchQueryResults couchDocs) {
				...
				if (exportArray != null) {
					...
					jdbi.useHandle(handle -> {
						...
						for (String colName : pgCols.keySet()) {
							...
							String n2Type = pgCols.get(colName).get("n2Type");
	...
	private void syncDocsForSchema(CouchQueryResults schemaDocs, String schemaName,
			Map<String, Map<String, Map<String, String>>> schemas) throws Exception {
		jdbi.useHandle(h -> {
