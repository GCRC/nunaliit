...
public class GeometrySimplificationProcessTest extends TestCase {
	...
	public void testSimplifyGeometryAtResolution() throws Exception {
		...
		tests.put("POINT(10.25 13)","POINT(10.3 13)");
		tests.put("MULTIPOINT((10.2 13),(11.2 14))","MULTIPOINT((10.2 13),(11.2 14))");
		tests.put("MULTIPOINT((10.28 13.02),(10.27 13.04))","POINT(10.3 13.0)");
		...
		tests.put("LINESTRING(0 0,0.04 0,0.04 0.04)","POINT(0 0)");
		...
		tests.put("MULTILINESTRING((0 0,0.04 0),(1 1,1.04 1))","MULTIPOINT((0 0),(1 1))");
		tests.put("MULTILINESTRING((0 0,0.04 0),(0.04 0,0.04 0.04))","POINT(0 0)");
		...
		tests.put("POLYGON((0 0,0.04 0,0.04 0.04,0 0.04))","POINT(0 0)");
		tests.put(
